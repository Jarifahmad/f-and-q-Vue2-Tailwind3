            ...
            <div class="max-w-4xl w-full">
                ...
                <div class="my-4">
                    ...
                    <div class="relative mt-4 flex"> <!-- enroll button here-->
                        <div>
                            <button class="bg-pink-500 text-indigo-100 font-bold mt-2 px-4 py-2 rounded-full text-xs uppercase">Enroll here</button>
                        </div>
                        
                        <div class="absolute right-0 bg-white rounded-full flex justify-center items-center p-5 border-4 border-pink-500">
                            <img class="w-16 h-16" src="" /> <!-- Add a logo picture link here -->
                        </div>
                    </div>
